...
void NetworkSupport::finishedSlot(QNetworkReply *reply) {
...
void NetworkSupport::printAttribute(QNetworkReply *reply, QNetworkRequest::Attribute code, QString codeStr) {
